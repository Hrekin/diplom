...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { depatrment_id: @query.depatrment_id, person_id: @query.person_id, quantity: @query.quantity, request_id: @query.request_id } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { depatrment_id: @query.depatrment_id, person_id: @query.person_id, quantity: @query.quantity, request_id: @query.request_id } }
